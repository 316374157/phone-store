...
public class MpTest {
    ...
    void testGenerator(){
        ...
        dataSourceConfig.setDbType(DbType.MYSQL) //设置数据库类型
                ...
                .setUrl("jdbc:mysql://localhost/vue1?useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT%2B8") //设置URL
                .setUsername("root")
                .setPassword("123456");
        //3.策略配置
        ...
        strategyConfig.setCapitalMode(true)  //是否打开全局大写命名
                ...
                .setInclude("book");  //设置要映射的表
        //4.包名策略配置
        PackageConfig packageConfig = new PackageConfig();
        packageConfig.setParent("com.phj.project1")  //设置父包名，即统一的包名前缀
